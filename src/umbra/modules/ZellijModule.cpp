...
void ZellijModule::printList() {
    ...
    // TODO: it probably makes sense to annotate the output from this function with what the path actually is, but this
    // is somewhat complicated to do generally
    auto list = util::listDirectoryPaths(this->lookupPaths);
